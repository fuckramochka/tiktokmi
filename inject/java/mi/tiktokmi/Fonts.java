...
public final class Fonts {
     ...
     */
    public static final String TWEMOJI_ASSET = "tiktokmi/twemoji.ttf";

    private static String packAsset(String which) {
        if (TWEMOJI.equals(which)) return TWEMOJI_ASSET;
        if (NOTO.equals(which)) return "tiktokmi/noto.ttf";
        if (BLOBMOJI.equals(which)) return "tiktokmi/blobmoji.ttf";
        return null;
    }
    ...
    public static File file(Context context) {
        return new File(context.getFilesDir(), "tiktokmi/font");
    }
    ...
    private static File emojiFile(Context context, String which) {
        return new File(context.getFilesDir(), "tiktokmi/emoji-" + which);
    }
