...
public final class Badges {
    ...
    private static final String SOURCE =
            "https://raw.githubusercontent.com/fuckramochka/tiktokmi/main/badges.json";
    private static final String FILES =
            "https://raw.githubusercontent.com/fuckramochka/tiktokmi/main/";
...
public static final String KEY = "badges_on";
    ...
    private static File file(Context context) {
        return new File(context.getFilesDir(), "tiktokmi/badges.json");
    }
    ...
    public static Bitmap picture(final Context context, final String path) {
        ...
        final File cache = new File(context.getFilesDir(), "tiktokmi/badges/" + name(path));
