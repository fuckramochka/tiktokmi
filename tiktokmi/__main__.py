"""TikTok MI's command line.

    python3 -m tiktokmi path/to/tiktok.apk
    python3 -m tiktokmi --badge supporter 7551880794956989495
"""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(
        prog="tiktokmi",
        description="Build TikTok MI from an official TikTok apk.",
    )
    ...
    parser.add_argument("-o", "--out", default=os.path.join(ROOT, "build", "tiktokmi.apk"),
